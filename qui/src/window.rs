...
use wayland::{
	...
	xdg_toplevel::{CloseEvent, MoveRequest},
...
impl Window {
	pub fn new(width: i32, height: i32) -> io::Result<Self> {
		...
		Self::new_with_context(ctx, width, height)
	}

	pub fn new_with_context(ctx: Rc<RefCell<WaylandContext>>, width: i32, height: i32) -> io::Result<Self> {
